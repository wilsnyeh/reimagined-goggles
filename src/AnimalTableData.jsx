          ...
          <>
            <div>
              {!selectedAnimalDetail.photo ? (
                ...
                <img
                  className="modal-img"
                  src={selectedAnimalDetail.photo}
                  width="relative"
                  height="200"
                  alt="hero"
                />
              ...
              <h1 className="modal-text">
                <strong>{selectedAnimalDetail.name}</strong>
              </h1>
              <table className="modal-table">
                ...
                <tbody>
                  <tr key={selectedAnimalDetail}>
                    ...
                    {!selectedAnimalDetail.email ? (
                      <td>❌</td>
                    ) : (
                      <td>{selectedAnimalDetail.email}</td>
                    )}
                    {!selectedAnimalDetail.orgAnimalId ? (
                      <td>❌</td>
                    ) : (
                      <td>{selectedAnimalDetail.orgAnimalId}</td>
                    )}
                  </tr>
                </tbody>
              </table>
